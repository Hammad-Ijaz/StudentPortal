...
namespace WebApiValidation.DTOs
{
    public class ServiceResponse 
    {
        ...
        public record class GetDataResponse(bool Flag, string Role,List<StudentViewModel> student);
        ...
        public record class GetTimeTableResponse(bool flag, string message, List<ScheduleClassViewModel> classes);
