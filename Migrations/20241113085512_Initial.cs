        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassId = table.Column<int>(type: "int", nullable: false),
                    Course_Id = table.Column<int>(type: "int", nullable: false),
                    Days = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    DurationTime = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", maxLength: 30, nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", maxLength: 30, nullable: false),
                    Room = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleClass", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduleClass_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "ClassId");
                    table.ForeignKey(
                        name: "FK_ScheduleClass_Courserecord_Course_Id",
                        column: x => x.Course_Id,
                        principalTable: "Courserecord",
                        principalColumn: "Course_Id");
                    table.ForeignKey(
                        name: "FK_ScheduleClass_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeacherCourse_Courserecord_Course_Id",
                        column: x => x.Course_Id,
                        principalTable: "Courserecord",
                        principalColumn: "Course_Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentCourses_Courserecord_Course_Id",
                        column: x => x.Course_Id,
                        principalTable: "Courserecord",
                        principalColumn: "Course_Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleClass_Course_Id",
                table: "ScheduleClass",
                column: "Course_Id");
